...
The ServiceX refresh token to redeem comes from the redeem request body,
not from the token — the token's only job is proving the call genuinely
...
broker blip does not take token verification down with it.
"""
